...
while new == 'yes':S
    while u_points < 100 and c_points < 100:
        os.system('cls')
        print("|S C O R E B O A R D|\n|___YOU___|___OPP___|\
        \n|         |         |\n|    %d    |    %d    |\
        \n|_________|_________|" % (u_points, c_points))
        t_1 = random.choice(list(range(1,4)))("\n\nWhat would you like to throw? \
        \n1. Rock \
        \n2. Paper \
        \n3. Scissors \
        ...
        if t_1 == '1': #Establishing your choice
            os.system('cls') #Clear previous
        
            t_2 = random.choice(computer) #The computers random choice
            ...
            if t_2 == 'rock':
                ...
                print('\nCaught between a rock and a... The score\
 remains ' \
